...
#include <queue>
#include "logging/uec_logger.h"
#include "host/uec_pull_pacer.h"
#include "host/uec_sink.h"
#include "host/uec_sink_port.h"
#include "host/uec_src.h"
#include "host/uec_src_port.h"
...
class LogSimInterface {
  public:
    ...
    bool latest_receive_updated() const {
        return _latest_recv != nullptr && _latest_recv->updated;
    }
    void terminate_sim();
    ...
    int64_t local_compute_time_override_ns = -1;
