...
public:
    ...
    static std::string event_to_str(RawLogEvent& event);
    Logger(){};
    virtual ~Logger(){};
...
public:
    ...
    virtual void logEvent(
        PacketFlow& flow, Logged& location, FlowEvent ev, mem_b bytes, uint64_t pkts) = 0;
...
public:
    ...
    virtual void logQcnQueue(
        QcnQueue& src, QcnQueueEvent ev, double var1, double var2, double var3) = 0;
    virtual ~QcnLogger(){};
};
