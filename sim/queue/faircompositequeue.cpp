...
FairCompositeQueue::FairCompositeQueue(linkspeed_bps bitrate,
                                       mem_b         maxsize,
                                       EventList&    eventlist,
                                       QueueLogger*  logger)
...
void FairCompositeQueue::completeService() {
    Packet* pkt;
...
void FairCompositeQueue::doNextEvent() {
    completeService();
}

void FairCompositeQueue::receivePacket(Packet& pkt) {
