...
RandomQueue::RandomQueue(
    linkspeed_bps bitrate, mem_b maxsize, EventList& eventlist, QueueLogger* logger, mem_b drop)
...
void RandomQueue::receivePacket(Packet& pkt) {
    ...
    //  cout << "Drop Prob "<<drop_prob<< " queue size "<< _queuesize/1000 << " queue id " << id <<
    //  endl;
    ...
    if (crt > _maxsize || drand() < drop_prob) {
        ...
        // cout << "Drop "<<drop_prob<< " queue size "<< _queuesize/1000 << " queue id " << _name <<
        // endl;
