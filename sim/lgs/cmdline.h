...
struct gengetopt_args_info
{
  ...
  double LogGOPS_G_arg;	/**< @brief The gap per byte parameter G in the LogGP model (default='6').  */
  ...
  char * comm_dep_file_arg;	/**< @brief Save the dependencies between sends/recvs to this file.  */
  char * comm_dep_file_orig;	/**< @brief Save the dependencies between sends/recvs to this file original value given at command line.  */
  const char *comm_dep_file_help; /**< @brief Save the dependencies between sends/recvs to this file help description.  */
  ...
  unsigned int comm_dep_file_given ;	/**< @brief Whether comm-dep-file was given.  */
