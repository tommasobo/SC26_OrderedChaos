...
const char *gengetopt_args_info_help[] = {
  ...
  "  -G, --LogGOPS_G=DOUBLE      The gap per byte parameter G in the LogGP model\n                                (default=`6')",
  ...
  "      --comm-dep-file=STRING  Save the dependencies between sends/recvs to this\n                                file",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->comm_dep_file_given = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->comm_dep_file_arg = NULL;
  args_info->comm_dep_file_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->comm_dep_file_help = gengetopt_args_info_help[19] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->comm_dep_file_arg));
  free_string_field (&(args_info->comm_dep_file_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->comm_dep_file_given)
    write_into_file(outfile, "comm-dep-file", args_info->comm_dep_file_orig, 0);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'G':	/* The gap per byte parameter G in the LogGP model.  */
          ...
          if (update_arg( (void *)&(args_info->LogGOPS_G_arg), 
               &(args_info->LogGOPS_G_orig), &(args_info->LogGOPS_G_given),
              &(local_args_info.LogGOPS_G_given), optarg, 0, "6", ARG_DOUBLE,
              check_ambiguity, override, 0, 0,
              "LogGOPS_G", 'G',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Save the dependencies between sends/recvs to this file.  */
          else if (strcmp (long_options[option_index].name, "comm-dep-file") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->comm_dep_file_arg), 
                 &(args_info->comm_dep_file_orig), &(args_info->comm_dep_file_given),
                &(local_args_info.comm_dep_file_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "comm-dep-file", '-',
                additional_error))
              goto failure;
