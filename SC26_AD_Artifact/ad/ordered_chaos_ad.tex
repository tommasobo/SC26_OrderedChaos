...
Completed runs collect clearly named PDFs and PNGs in one result directory.
The directory also contains a \texttt{PASS} marker and the execution identifier
used to generate it.
