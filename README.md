...
minutes for the short workflow and 24 to 48 hours for the full workflow.
...
The Slurm files contain no account or partition names. If required by a site,
provide them at launch time:
